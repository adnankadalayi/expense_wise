          ...
          children: [
            _buildSettingsSection(controller, 'Preferences', [
              ...
              _buildSettingItem(
                ...
                title: 'Reports',
                subtitle: 'View analytics and export PDFs',
              ...
              _buildSettingItem(
                ...
                subtitle: 'Financial independence tracker',
                onTap: () => Get.toNamed('/fire'),
                action: const Text(
                  '›',
                  style: TextStyle(fontSize: 16, color: Color(0xFFF7B500)),
                ),
              ...
              _buildSettingItem(
                ...
                subtitle: 'View balance transfers',
                onTap: () => Get.toNamed('/transfer-history'),
                action: const Text(
                  '›',
                  style: TextStyle(fontSize: 16, color: Color(0xFFF7B500)),
                ),
            ...
            _buildSettingsSection(controller, 'Security', [
              _buildSettingItem(
                controller,
                index: 11,
                icon: '🔒',
                ...
                subtitle: 'App lock, PIN, biometric auth',
