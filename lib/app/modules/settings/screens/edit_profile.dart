import 'package:expense_wise/app/modules/settings/controllers/edit_profile_controller.dart';
                        ...
                        () => GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            transform: Matrix4.identity()
                              ..scale(
                                controller.isAvatarTapped.value ? 0.95 : 1.0,
                                controller.isAvatarTapped.value ? 0.95 : 1.0,
                                1.0,
                              ),
                            child: Center(
                              ...
                              child: Obx(
                                () => GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    transform: Matrix4.identity()
                                      ..scale(
                                        controller.isCancelTapped.value
                                            ? 0.98
                                            : 1.0,
                                        controller.isCancelTapped.value
                                            ? 0.98
