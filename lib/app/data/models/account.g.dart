...
const AccountSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'excludeFromTotal': PropertySchema(
      id: 3,
      name: r'excludeFromTotal',
      type: IsarType.bool,
    ),
...
void _accountSerialize(
  ...
  writer.writeBool(offsets[3], object.excludeFromTotal);
  writer.writeLong(offsets[4], object.iconCodePoint);
  writer.writeString(offsets[5], object.name);
  writer.writeBool(offsets[6], object.showOnHome);
...
Account _accountDeserialize(
  ...
  object.excludeFromTotal = reader.readBool(offsets[3]);
  object.iconCodePoint = reader.readLongOrNull(offsets[4]);
  object.id = id;
  object.name = reader.readString(offsets[5]);
  object.showOnHome = reader.readBool(offsets[6]);
  object.type =
      _AccounttypeValueEnumMap[reader.readByteOrNull(offsets[7])] ??
      AccountType.bank;
  return object;
}
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> excludeFromTotalEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'excludeFromTotal', value: value),
      );
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition> iconCodePointIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> showOnHomeEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'showOnHome', value: value),
      );
    });
  }
...
extension AccountQuerySortBy on QueryBuilder<Account, Account, QSortBy> {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByExcludeFromTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'excludeFromTotal', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByExcludeFromTotalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'excludeFromTotal', Sort.desc);
    });
  }
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByShowOnHome() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showOnHome', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByShowOnHomeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQuerySortThenBy
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByExcludeFromTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'excludeFromTotal', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByExcludeFromTotalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'excludeFromTotal', Sort.desc);
    });
  }
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByShowOnHome() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showOnHome', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByShowOnHomeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showOnHome', Sort.desc);
    });
  }
...
extension AccountQueryWhereDistinct
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByExcludeFromTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'excludeFromTotal');
    });
  }
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByShowOnHome() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, bool, QQueryOperations> excludeFromTotalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'excludeFromTotal');
    });
  }
  ...
  QueryBuilder<Account, bool, QQueryOperations> showOnHomeProperty() {
    return QueryBuilder.apply(this, (query) {
